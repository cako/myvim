...
map <F4> ;python run_these_lines(mode='norm')<CR>
vmap <F4> ;python run_these_lines(mode='vis')<CR>
map <C-F6> ;python send('%pdb')<CR>
map <F6> ;python set_breakpoint()<CR>
map <s-F6> ;python clear_breakpoint()<CR>
map <F7> ;python run_this_file_pdb()<CR>
map <s-F7> ;python clear_all_breakpoints()<CR>
map <F9> ;call <SID>toggle_send_on_save()<CR>
map <S-F9> ;python toggle_reselect()<CR>
imap <F4> <ESC><F4>a
